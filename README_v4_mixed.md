...
🔭 AI 기반 서비스 개발에 집중 중 | 🌱 LLM, RAG, 최신 AI 기술 학습 중 | 💡 기술로 문제 해결하기
...
### 🔍 CTRLF - AI 문서 검색 시스템
> **SK쉴더스 최종 프로젝트** | 팀 프로젝트

RAGFlow를 활용한 지능형 문서 검색 및 AI 답변 시스템

| 주요 기능 | 기술 |
|----------|------|
| 대량 문서 의미론적 검색 | RAG, LangChain |
| AI 자연어 질의응답 | Python, RAGFlow |
...
> AI 기반 재무제표 분석 웹 애플리케이션

재무제표 업로드 → AI 자동 분석 → 인사이트 시각화

| 주요 기능 | 기술 |
|----------|------|
| 재무제표 자동 파싱 | Python |
| GPT 기반 분석 | OpenAI API |
| 시각화 대시보드 | Streamlit |
